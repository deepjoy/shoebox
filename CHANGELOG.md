...
- migrate taskmill from 0.5 to 0.6 type-safe context API ([#100](https://github.com/deepjoy/shoebox/pull/100))
...
- remove debug symbols from release profile to reduce binary size ([#92](https://github.com/deepjoy/shoebox/pull/92))

## [0.5.1](https://github.com/deepjoy/shoebox/compare/v0.5.0...v0.5.1) - 2026-03-18

### Other

- *(deps)* upgrade taskmill to v0.4.0 ([#90](https://github.com/deepjoy/shoebox/pull/90))
