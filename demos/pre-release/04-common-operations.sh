...
p01_server_startup() {
  ...
  extract_credentials "$BUCKET_A"
  PHOTOS_ACCESS_KEY="$ACCESS_KEY"
  PHOTOS_SECRET_KEY="$SECRET_KEY"
  setup_aws_env "$ACCESS_KEY" "$SECRET_KEY" "$ENDPOINT"

  ok "Server started on $ENDPOINT with buckets: photos, archive"
}
part p01_server_startup "Phase 4 — Common Object Operations"
...
part p02_seed_data "Setup — Upload Test Objects"

p03_copy_same_bucket() {
...
p04_copy_cross_bucket() {
  ...
  export AWS_ACCESS_KEY_ID="$PHOTOS_ACCESS_KEY"
  export AWS_SECRET_ACCESS_KEY="$PHOTOS_SECRET_KEY"
}
part p04_copy_cross_bucket "CopyObject — Cross Bucket"

p05_copy_conditional() {
...
part p05_copy_conditional "CopyObject — Conditional Headers"
...
part p06_range_requests "Range Requests — Partial Content"

p07_conditional_requests() {
...
part p07_conditional_requests "Conditional Requests"
...
part p08_tagging "Object Tagging — Put / Get / Delete"
...
part p09_tag_limits "Object Tagging — Limit Enforcement"
...
part p10_rename "Rename — Atomic File Move"
...
part p99_done "Phase 4 Demo Complete"
